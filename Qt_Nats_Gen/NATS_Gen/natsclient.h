// comes from: https://github.com/pkoretic/qt-nats/blob/master/natsclient.h
#ifndef NATSCLIENT_H
#define NATSCLIENT_H
...
namespace Nats
{
    ...
    public:
        ...
        //void (*connect_callback_fct) ();
        //void setConnectCallbackFct (void (*func)()) {connect_callback_fct = func;}
